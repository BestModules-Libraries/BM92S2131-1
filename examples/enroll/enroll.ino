...
BM92S2131_1 fps(2,4,5);        //rxPin:4, txPin:5, Please comment this line of code if don't use SW Serial
//BM92S2131_1 fps(2,&Serial1);  // Please uncomment this line of code if you use HW Serial1 on BMduino
//BM92S2131_1 fps(2,&Serial2);  // Please uncomment this line of code if you use HW Serial2 on BMduino
//BM92S2131_1 fps(2,&Serial3);  // Please uncomment this line of code if you use HW Serial3 on BMduino
//BM92S2131_1 fps(2,&Serial4);  // Please uncomment this line of code if you use HW Serial4 on BMduino 
uint16_t id =1;
