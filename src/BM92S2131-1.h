...
******************************************************************/
#ifndef BM92S2131_1_H
#define BM92S2131_1_H

#include "Arduino.h"
#include "SoftwareSerial.h"
#define BM92S2131_1_NO_KEY 0
...
class BM92S2131_1
{
  public:
    ...
    BM92S2131_1(uint8_t keyoutPin=2,HardwareSerial *theSerial = &Serial);
    BM92S2131_1(uint8_t keyoutPin,uint8_t rxPin, uint8_t txPin);
